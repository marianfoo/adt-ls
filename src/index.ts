...
export type { InteractiveCallbacks, LogonContext, LogonStrategy } from './auth/strategy.js';
...
// Federated MCP result unwrap (for consumers that call raw.tool directly)
export { parseFederated } from './channels/federated.js';
export type { FederatedResult } from './channels/federated.js';

// Common types
export type { ObjectRef } from './api/lifecycle.js';
export type { Locator } from './api/navigation.js';
export type { SearchReference, UserRef } from './api/repository.js';

// Advanced / escape hatches
export { AdtLsDriver } from './driver.js';
export type { AdtLsDriverOptions, AdtLsInitializeResult } from './driver.js';
