...
export const REQUIRED_SAPSE_ADT_VSCODE_VERSION = '1.0.1';
export const MINIMUM_ADT_LS_VERSION = '1.0.1';
export const VERIFIED_ADT_LS_VERSION = '1.0.1.202606111342';

type ParsedVersion = readonly [major: number, minor: number, patch: number];

export function parseAdtLsVersion(version: string | undefined): ParsedVersion | undefined {
